...
var loadYoga = function () {
  ...
  return function (loadYoga) {
    ...
    var ka = g.print || console.log.bind(console),
      la = g.printErr || console.warn.bind(console);
    Object.assign(g, da);
    da = null;
    var ma;
    g.wasmBinary && (ma = g.wasmBinary);
    var noExitRuntime = g.noExitRuntime || !0;
    function na() {
      this.buffer = new ArrayBuffer(oa / 65536 * 65536);
    }
    function pa(a) {
      this.exports =
    ...
    var ra = Error,
      WebAssembly = {};
    ma = [];
    "object" != _typeof(WebAssembly) && _q("no native wasm support detected");
    var v,
      sa = !1;
    function w(a, b, c) {
      c = b + c;
    ...
    var _x, ta, _z, A, ua, _C, D, va, wa;
    function xa(a) {
      _x = a;
      g.HEAP8 = ta = new Int8Array(a);
      g.HEAP16 = A = new Int16Array(a);
      g.HEAP32 = _C = new Int32Array(a);
      g.HEAPU8 = _z = new Uint8Array(a);
    ...
    var oa = g.INITIAL_MEMORY || 16777216;
    g.wasmMemory ? v = g.wasmMemory : v = new na();
    v && (_x = v.buffer);
    oa = _x.byteLength;
    xa(_x);
    var ya,
    ...
    function _q(a) {
      ...
      la(a);
      sa = !0;
      a = new ra(a + ". Build with -sASSERTIONS for more info.");
      ca(a);
      throw a;
    }
    ...
    if (!H.startsWith(Ea)) {
      var Fa = H;
      H = g.locateFile ? g.locateFile(Fa, ea) : ea + Fa;
    }
    function Ga() {
      var a = H;
      try {
        if (a == H && ma) return new Uint8Array(ma);
        var b = ja(a);
        if (b) return b;
        if (ha) return ha(a);
      ...
      Na = function Na(a) {
        switch (a) {
          ...
          case !1:
            return 4;
          default:
            var b = La.length ? La.pop() : I.length;
            I[b] = {
              ha: 1,
              value: a
            };
    ...
    var O = void 0,
      P = {};
    function Ra(a, b) {
      for (void 0 === b && K("ptr should not be undefined"); a.R;) b = a.ba(b), a = a.R;
      return b;
    }
    var Q = {};
    function Sa(a) {
    ...
    function Ua(a, b) {
      var c = Q[a];
      void 0 === c && K(b + " has unknown type " + Sa(a));
      return c;
    }
    function Va() {}
    var Wa = !1;
    ...
    function cb(a, b) {
      b.P && b.O || bb("makeClassHandle requires ptr and ptrType");
      !!b.U !== !!b.T && bb("Both smartPtrType and smartPtr must be specified");
      b.count = {
        value: 1
      };
    ...
    function S(a) {
      ...
      Wa = new FinalizationRegistry(function (b) {
        Xa(b.M);
      });
      S = function S(b) {
        var c = b.M;
    ...
    function T(a) {
      return this.fromWireType(_C[a >> 2]);
    }
    var U = {},
      fb = {};
    function V(a, b, c) {
      function d(k) {
        k = c(k);
        k.length !== a.length && bb("Mismatched type converter count");
      ...
      b.forEach(function (k, m) {
        Q.hasOwnProperty(k) ? e[m] = Q[k] : (f.push(k), U.hasOwnProperty(k) || (U[k] = []), U[k].push(function () {
          e[m] = Q[k];
          ++h;
          h === f.length && d(e);
        }));
    ...
    function hb(a) {
      K(a.M.P.N.name + " instance already deleted");
    }
    function X() {}
    function ib(a, b, c) {
      if (void 0 === a[b].S) {
        var d = a[b];
        a[b] = function () {
          a[b].S.hasOwnProperty(arguments.length) || K("Function '" + c + "' called with an invalid number of arguments (" + arguments.length + ") - expects one of (" + a[b].S + ")!");
    ...
    function jb(a, b) {
      g.hasOwnProperty(a) ? (K("Cannot register public name '" + a + "' twice"), ib(g, a, a), g.hasOwnProperty(void 0) && K("Cannot register multiple overloads of a function with the same number of arguments (undefined)!"), g[a].S[void 0] = b) : g[a] = b;
    }
    function kb(a, b, c, d, e, f, h, k) {
      this.name = a;
      this.constructor = b;
      this.X = c;
      this.W = d;
    ...
    function lb(a, b, c) {
      for (; b !== c;) b.ba || K("Expected null or instance of " + c.name + ", got an instance of " + b.name), a = b.ba(a), b = b.R;
      return a;
    }
    function mb(a, b) {
      if (null === b) return this.fa && K("null is not a valid " + this.name), 0;
      b.M || K('Cannot pass "' + pb(b) + '" as a ' + this.name);
      b.M.O || K("Cannot pass deleted object as a pointer of type " + this.name);
      return lb(b.M.O, b.M.P.N, this.N);
    }
    function qb(a, b) {
      if (null === b) {
        this.fa && K("null is not a valid " + this.name);
        if (this.ea) {
          var c = this.ga();
      ...
      b.M || K('Cannot pass "' + pb(b) + '" as a ' + this.name);
      b.M.O || K("Cannot pass deleted object as a pointer of type " + this.name);
      !this.da && b.M.P.da && K("Cannot convert argument of type " + (b.M.U ? b.M.U.name : b.M.P.name) + " to parameter type " + this.name);
      c = lb(b.M.O, b.M.P.N, this.N);
      if (this.ea) switch (void 0 === b.M.T && K("Passing raw pointer to smart pointer is illegal"), this.Ca) {
        case 0:
          b.M.U === this ? c = b.M.T : K("Cannot convert argument of type " + (b.M.U ? b.M.U.name : b.M.P.name) + " to parameter type " + this.name);
          break;
        case 1:
          c = b.M.T;
          break;
    ...
    function rb(a, b) {
      ...
      b.M || K('Cannot pass "' + pb(b) + '" as a ' + this.name);
      b.M.O || K("Cannot pass deleted object as a pointer of type " + this.name);
      b.M.P.da && K("Cannot convert argument of type " + b.M.P.name + " to parameter type " + this.name);
      return lb(b.M.O, b.M.P.N, this.N);
    }
    function Y(a, b, c, d) {
      this.name = a;
      ...
      this.da = d;
      this.ea = !1;
      this.W = this.ya = this.ga = this.la = this.Ca = this.xa = void 0;
      void 0 !== b.R ? this.toWireType = qb : (this.toWireType = d ? mb : rb, this.V = null);
    }
    function sb(a, b) {
      g.hasOwnProperty(a) || bb("Replacing nonexistant public symbol");
      g[a] = b;
      g[a].Z = void 0;
    }
    function tb(a, b) {
      ...
      return function () {
        ...
        } else d = ya.get(b).apply(null, c);
        return d;
      };
    }
    function Z(a, b) {
      a = M(a);
      var c = a.includes("j") ? tb(a, b) : ya.get(b);
    ...
    function vb(a, b) {
      function c(f) {
        e[f] || Q[f] || (fb[f] ? fb[f].forEach(c) : (d.push(f), e[f] = !0));
      }
      var d = [],
        e = {};
      b.forEach(c);
      throw new ub(a + ": " + d.map(Sa).join([", "]));
    }
    function wb(a, b, c, d, e) {
      ...
      return function () {
        ...
        t = d.apply(null, p);
        if (k) eb(r);else for (var y = h ? 1 : 2; y < b.length; y++) {
          var B = 1 === y ? u : n[y - 2];
          null !== b[y].V && b[y].V(B);
        }
    ...
    function yb(a) {
      4 < a && 0 === --I[a].ha && (I[a] = void 0, La.push(a));
    }
    function pb(a) {
    ...
    function Lb(a, b) {
      for (var c = Array(a), d = 0; d < a; ++d) c[d] = Ua(D[b + 4 * d >> 2], "parameter " + d);
      return c;
    }
    var Mb = [],
      Nb = [null, [], []];
    J = g.BindingError = Ma("BindingError");
    ...
    Oa = g.PureVirtualError = Ma("PureVirtualError");
    for (var Ob = Array(256), Pb = 0; 256 > Pb; ++Pb) Ob[Pb] = String.fromCharCode(Pb);
    Pa = Ob;
    ...
    g.flushPendingDeletes = Qa;
    g.setDelayFunction = function (a) {
      O = a;
      N.length && O && O(Qa);
    };
    ab = g.InternalError = Ma("InternalError");
    ...
    X.prototype["delete"] = function () {
      this.M.O || hb(this);
      this.M.$ && !this.M.aa && K("Object already scheduled for deletion");
      Va(this);
      Xa(this.M);
    ...
    Y.prototype.fromWireType = function (a) {
      ...
      d = this.da ? d.ma : d.pointerType;
      var e = Ya(c, this.N, d.N);
      return null === e ? b.call(this) : this.ea ? cb(d.N.X, {
        P: d,
        O: e,
        U: this,
        T: a
    ...
    ub = g.UnboundTypeError = Ma("UnboundTypeError");
    function ja(a) {
      if (a.startsWith(Ea)) return a = a.slice(Ea.length), a = Buffer.from(a, "base64"), new Uint8Array(a.buffer, a.byteOffset, a.byteLength);
    }
    var Rb = {
      j: function j(a, b, c, d) {
        _q("Assertion failed: " + (a ? w(_z, a) : "") + ", at: " + [b ? b ? w(_z, b) : "" : "unknown filename", c, d ? d ? w(_z, d) : "" : "unknown function"]);
      },
      r: function r(a, b, c) {
        a = M(a);
        b = Ua(b, "wrapper");
        ...
        var d = [].slice,
          ...
          k = e.R.constructor;
        a = Ka(a, function () {
          e.R.ka.forEach(function (l) {
            if (this[l] === h[l]) throw new Oa("Pure virtual function " + l + " must be implemented in JavaScript");
          }.bind(this));
        ...
        V([a], f, function (h) {
          ...
          e.forEach(function (m, l) {
            ...
            k[m.pa] = {
              ...
              write: function write(B, aa) {
                var G = [];
                t(y, B, u.toWireType(G, aa));
                eb(G);
              }
            };
          });
      ...
      C: function C(a, b, c, d, e) {
        ...
        W(a, {
          ...
          readValueFromPointer: function readValueFromPointer(h) {
            if (1 === c) var k = ta;else if (2 === c) k = A;else if (4 === c) k = _C;else throw new TypeError("Unknown boolean type size: " + b);
      ...
      g: function g(a, b, c, d, e, f, h, k, m, l, n, p, r) {
        ...
        V([a, b, c], d ? [d] : [], function (t) {
          ...
          t = Ka(u, function () {
            ...
            if (void 0 === G.Y) throw new J(n + " has no accessible constructor");
            var nb = G.Y[arguments.length];
            if (void 0 === nb) throw new J("Tried to invoke ctor of " + n + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(G.Y).toString() + ") parameters instead!");
            return nb.apply(this, arguments);
          });
          var aa = Object.create(B, {
            constructor: {
              value: t
            }
          });
          t.prototype = aa;
          var G = new kb(n, t, aa, r, y, f, k, l);
          y = new Y(n, G, !0, !1);
          B = new Y(n + "*", G, !1, !1);
          var ob = new Y(n + " const*", G, !1, !0);
          Za[a] = {
            pointerType: B,
            ma: ob
          };
      ...
      e: function e(a, b, c, d, _e2, f, h) {
        ...
        V([], [a], function (m) {
          function l() {
            vb("Cannot call " + n + " due to unbound types", k);
          }
          m = m[0];
          var n = m.name + "." + b;
          b.startsWith("@@") && (b = Symbol[b.substring(2)]);
          var p = m.N.constructor;
          void 0 === p[b] ? (l.Z = c - 1, p[b] = l) : (ib(p, b, n), p[b].S[c - 1] = l);
          V([], k, function (r) {
      ...
      q: function q(a, b, c, d, e, f) {
        ...
        V([], [a], function (k) {
          ...
          void 0 === k.N.Y && (k.N.Y = []);
          if (void 0 !== k.N.Y[b - 1]) throw new J("Cannot register multiple constructors with identical number of parameters (" + (b - 1) + ") for class '" + k.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!");
          k.N.Y[b - 1] = function () {
            vb("Cannot construct " + k.name + " due to unbound types", h);
          };
          V([], h, function (l) {
            l.splice(1, 0, null);
            k.N.Y[b - 1] = wb(m, l, null, e, f);
            return [];
          });
          return [];
        });
      ...
      b: function b(a, _b2, c, d, e, f, h, k) {
        ...
        V([], [a], function (l) {
          function n() {
            vb("Cannot call " + p + " due to unbound types", m);
          }
          l = l[0];
          var p = l.name + "." + _b2;
          ...
          var r = l.N.X,
            u = r[_b2];
          void 0 === u || void 0 === u.S && u.className !== l.name && u.Z === c - 2 ? (n.Z = c - 2, n.className = l.name, r[_b2] = n) : (ib(r, _b2, p), r[_b2].S[c - 2] = n);
          V([], m, function (t) {
            t = wb(p, t, l, f, h);
      ...
      f: function f(a, b, c, d, e) {
        ...
        W(a, {
          ...
          toWireType: c,
          argPackAdvance: 8,
          readValueFromPointer: Ab(b, e, 0 !== d),
          V: null
        });
      },
        ...
        W(a, {
          ...
          fromWireType: function fromWireType(d) {
            ...
            if (c) for (var h = f, k = 0; k <= e; ++k) {
              ...
              l = Array(e);
              for (k = 0; k < e; ++k) l[k] = String.fromCharCode(_z[f + k]);
              l = l.join("");
            }
            R(d);
            return l;
          ...
          toWireType: function toWireType(d, e) {
            ...
            } else if (h) for (h = 0; h < f; ++h) l = e.charCodeAt(h), 255 < l && (R(m), K("String has UTF-16 code units that do not fit in 8 bits")), _z[m + h] = l;else for (h = 0; h < f; ++h) _z[m + h] = e[h];
            null !== d && d.push(R, k);
            return k;
          },
          argPackAdvance: 8,
      ...
      k: function k(a, b, c) {
        ...
        if (2 === b) {
          ...
          var k = 1;
        } else 4 === b && (d = Eb, e = Fb, f = Gb, h = function h() {
          return D;
        }, k = 2);
        W(a, {
          name: c,
      ...
      n: function n(a, b) {
        ...
        var f = Array(a - 1);
        e = Kb(function (h, k, m, l) {
          for (var n = 0, p = 0; p < a - 1; ++p) f[p] = c[p + 1].readValueFromPointer(l + n), n += c[p + 1].argPackAdvance;
          h = h[k].apply(h, f);
          for (p = 0; p < a - 1; ++p) c[p + 1].na && c[p + 1].na(f[p]);
          if (!d.wa) return d.toWireType(m, h);
        });
        return Mb[b] = e;
      },
      E: function E(a) {
      ...
      x: function x(a) {
        ...
        for (var c = 1; 4 >= c; c *= 2) {
          ...
          a: {
            try {
              v.grow(e - _x.byteLength + 65535 >>> 16);
              xa(v.buffer);
              var f = 1;
              break a;
            } catch (h) {}
      ...
      z: function z(a, b, c, d) {
        for (var e = 0, f = 0; f < c; f++) {
          ...
          for (var m = 0; m < k; m++) {
            var l = _z[h + m],
              n = Nb[a];
            0 === l || 10 === l ? ((1 === a ? ka : la)(w(n, 0)), n.length = 0) : n.push(l);
          }
          e += k;
        }
        D[d >> 2] = e;
    ...
    (function () {
      function a(c) {
        ...
        0 == E && (null !== Da && (clearInterval(Da), Da = null), F && (c = F, F = null, c()));
      }
      var b = {
        a: Rb
      };
      ...
      if (g.instantiateWasm) try {
        ...
        la("Module.instantiateWasm callback failed with error: " + c), ca(c);
      }
      (function (c) {
    ...
    var Ta = g.___getTypeName = function () {
      return (Ta = g.___getTypeName = g.asm.G).apply(null, arguments);
    };
    g.__embind_initialize_bindings = function () {
      return (g.__embind_initialize_bindings = g.asm.H).apply(null, arguments);
    };
    var Qb = g._malloc = function () {
        return (Qb = g._malloc = g.asm.I).apply(null, arguments);
      },
      R = g._free = function () {
        return (R = g._free = g.asm.K).apply(null, arguments);
      };
    ...
    function Ub() {
      ...
      if (!(0 < E)) {
        if (g.preRun) for ("function" == typeof g.preRun && (g.preRun = [g.preRun]); g.preRun.length;) Ca();
        Ia(za);
